        ...
        NavigationView {
            ZStack {
                VStack {
                    ...
                    .padding(.bottom, 48)
                    ZStack {
                        BasicText(text:"This Mee app holds personal data about you and protects it using your phone's faceID. However, if all of your devices are ever lost, as well as backup access, you will need to enter a passphrase to recover your personal data.", size: 16)
                    ...
                    HStack {
                        ...
                        BasicText(text:"How to use Mee app?", fontName: FontNameManager.PublicSans.medium)
                    }.padding(.bottom, 73)
